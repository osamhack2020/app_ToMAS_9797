...
public class survey_content_result_list_adapter extends RecyclerView.Adapter<survey_content_result_list_adapter.MyViewHolder> {
    ...
    public survey_content_result_list_adapter(String tmp_path, String tmp_post_id, FragmentManager tmp_fragmentManager)
    {
    ...
    @Override
    public survey_content_result_list_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                              int viewType) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment change_fragment = new survey_content_result_individual();
