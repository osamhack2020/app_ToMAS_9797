...
public class RegisterMarketContent extends AppCompatActivity {
    Editor editor;
    EditText edit_date;
        ...
        edit_date.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN)
                {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(RegisterMarketContent.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            ArrayAdapter<String> category_adapter = new ArrayAdapter<>(RegisterMarketContent.this, android.R.layout.simple_spinner_item, items);
    ...
    private void setUpEditor() {
        ...
        findViewById(R.id.action_color).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new ColorPickerPopup.Builder(RegisterMarketContent.this)
...
//        startActivity(intent);
        ...
        findViewById(R.id.btnRender).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RegisterMarketContent.this, RenderPreview.class);
