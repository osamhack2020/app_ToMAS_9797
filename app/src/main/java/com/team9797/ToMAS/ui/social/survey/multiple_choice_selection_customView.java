...
public class multiple_choice_selection_customView extends LinearLayout {
    ...
    public multiple_choice_selection_customView(@NonNull Context context) {
        this(context, null);
    }

    public multiple_choice_selection_customView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        tmp_context = context;
