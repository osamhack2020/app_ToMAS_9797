...
public class SocialBoard extends Fragment {
    ...
    public SocialBoard(String tmp_union)
    {
        union = tmp_union;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        else
        {
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(mainActivity, RegisterSocialBoardContent.class);
        ...
        SocialBoardListAdapter adapter = new SocialBoardListAdapter(path, fragmentManager);
