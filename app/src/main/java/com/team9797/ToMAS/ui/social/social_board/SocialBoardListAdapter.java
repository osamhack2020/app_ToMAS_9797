...
public class SocialBoardListAdapter extends RecyclerView.Adapter<SocialBoardListAdapter.MyViewHolder> {
    public ArrayList<SocialBoardListItem> mDataset;
    FragmentManager fragmentManager;
    FragmentTransaction fragmentTransaction;
    String path;
    Context context;

    public SocialBoardListAdapter(String tmp_path, FragmentManager tmp_fragmentManager)
    {
    ...
    @Override
    public SocialBoardListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                  int viewType) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment change_fragment = new SocialBoardContent();
    ...
    {
        SocialBoardListItem item = new SocialBoardListItem();
