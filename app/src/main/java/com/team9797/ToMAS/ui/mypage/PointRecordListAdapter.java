...
public class PointRecordListAdapter extends RecyclerView.Adapter<PointRecordListAdapter.MyViewHolder> {
    public ArrayList<PointRecordListItem> mDataset;

    public PointRecordListAdapter()
    {
    ...
    @Override
    public PointRecordListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                  int viewType) {
    ...
    {
        PointRecordListItem item = new PointRecordListItem();
