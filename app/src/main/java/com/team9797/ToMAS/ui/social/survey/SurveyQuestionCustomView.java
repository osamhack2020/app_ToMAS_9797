...
public class SurveyQuestionCustomView extends LinearLayout {
    ...
    ArrayList<MultipleChoiceSelectionCustomView> multi_chice_selection_list;
    public Context tmp_context;
    public int index;



    public SurveyQuestionCustomView(@NonNull Context context) {
        this(context, null);
    }

    public SurveyQuestionCustomView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        tmp_context = context;
