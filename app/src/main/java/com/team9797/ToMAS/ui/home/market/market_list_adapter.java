...
public class market_list_adapter extends BaseAdapter {
    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    public ArrayList<market_list_item> listViewItemList = new ArrayList<market_list_item>() ;

    // ListViewAdapter의 생성자
    public market_list_adapter() {
    ...
    public void addItem(String title, int numpeople, String date, String name, int price, String post_id) {
        market_list_item item = new market_list_item();
