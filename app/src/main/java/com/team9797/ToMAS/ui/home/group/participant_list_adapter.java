...
public class participant_list_adapter extends BaseAdapter {
    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    public ArrayList<participant_list_item> listViewItemList = new ArrayList<participant_list_item>() ;

    // ListViewAdapter의 생성자
    public participant_list_adapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        participant_list_item listViewItem = listViewItemList.get(position);
