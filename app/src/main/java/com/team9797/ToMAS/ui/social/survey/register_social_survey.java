...
public class register_social_survey extends AppCompatActivity {
    ...
    ArrayList<survey_question_customView> question_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_date.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN)
                {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(register_social_survey.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                survey_question_customView tmp_customView = new survey_question_customView(register_social_survey.this);
