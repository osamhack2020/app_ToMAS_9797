...
public class market_content extends Fragment implements Html.ImageGetter {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        html_textView.setText(Html.fromHtml(document.get("html", String.class), market_content.this, null));
